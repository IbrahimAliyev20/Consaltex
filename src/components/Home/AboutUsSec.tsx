...
interface AboutUsSecProps {
  showButton?: boolean;
}

export default async function AboutUsSec({ showButton = true }: AboutUsSecProps) {
    ...
    <section className=" container mx-auto px-4  ">
      <div className="grid lg:grid-cols-2 gap-12 items-start">
        <div className="space-y-6">
          ...
          {showButton && (
            <Button className=" w-[161px] bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-md flex items-center gap-2 transition-colors">
